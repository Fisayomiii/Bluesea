<template>
    ...
    <EmptyInputToast v-if="showErrorToast" />
...
import EmptyInputToast from "../UI/EmptyInputToast.vue";
import SuccesfullyUploadedToast from "../UI/SuccesfullyUploadedToast.vue";

export default {
    components: { EmptyInputToast, SuccesfullyUploadedToast, PostsComponent },
    setup() {
